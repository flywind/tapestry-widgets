...
function(XHEDITOR, $, undefined) {
    ...
    if ($("script[src*=xheditor]").each(function() {
        var a = this.src;
        return a.match(/xheditor[^\/]*\.js/i) ? (editorRoot = a.replace(/[\?#].*$/, "").replace(/(^|[\/\\])[^\/]*$/, "$1"),
        !1) : void 0
    }
    ),
    isIE) {
    ...
    var specialKeys = {
      ...
      , toolsThemes = {
        ...
        simple: "Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,|,Align,List,Outdent,Indent,|,Link,Img",
        full: "Cut,Copy,Paste,Pastetext,|,Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,SelectAll,Removeformat,|,Align,List,Outdent,Indent,|,Link,Unlink,Anchor,Img,Flash,Media,Hr,Table,|,Source,Preview,Print,Fullscreen"
    };
    ...
    var arrDbClick = {
      ...
      , Xheditor = function(textarea, options) {
        ...
        function checkEsc(a) {
            return 27 === a.which ? (bShowModal ? _this.removeModal() : bShowPanel && _this.hidePanel(),
            !1) : void 0
        }
        function loadReset() {
        ...
        function cleanPaste(a) {
            ...
            isIE || isIE11 ? (l.moveToElementText(j),
            l.select()) : (l.selectNodeContents(j),
            k.removeAllRanges(),
            k.addRange(l)),
            setTimeout(function() {
                var a, b = 3 === g;
                if (b)
                    i.html(i.html().replace(/<br(\s+[^<>]*)?>/gi, "\n")),
                    a = i.text();
                else {
                ...
                _this.loadBookmark(),
                a = a.replace(/^[\s\uFEFF]+|[\s\uFEFF]+$/g, ""),
                a && (b ? _this.pasteText(a) : (a = _this.cleanHTML(a),
                a = _this.cleanWord(a),
                a = _this.formatXHTML(a),
                (!settings.onPaste || settings.onPaste && (a = settings.onPaste(a)) !== !1) && (a = replaceRemoteImg(a),
                _this.pasteHTML(a)))),
                bCleanPaste = !1
            }
            , 0)
        ...
        function replaceRemoteImg(a) {
            ...
            if (b && c) {
                ...
                a = a.replace(/(<img)((?:\s+[^>]*?)?(?:\s+src="\s*([^"]+)\s*")(?: [^>]*)?)(\/?>)/gi, function(a, c, f, g, h) {
                    return !/^(https?|data:image)/i.test(g) || /_xhe_temp/.test(f) || b.test(g) || (d[e] = g,
                    f = f.replace(/\s+(width|height)="[^"]*"/gi, "").replace(/\s+src="[^"]*"/gi, ' src="' + skinPath + 'img/waiting.gif" remoteimg="' + e++ + '"')),
                    c + f + h
                }
                ),
                d.length > 0 && $.post(c, {
        ...
        function forcePtag(a) {
            if (bSource || 13 !== a.which || a.shiftKey || a.ctrlKey || a.altKey)
                return !0;
            var b = _this.getParent("p,h1,h2,h3,h4,h5,h6,pre,address,div,li");
            return b.is("li") ? !0 : settings.forcePtag ? void (0 === b.length && _this._exec("formatblock", "<p>")) : (_this.pasteHTML("<br />"),
            isIE && b.length > 0 && 2 === _this.getRng().parentElement().childNodes.length && _this.pasteHTML("<br />"),
            !1)
        }
        function fixFullHeight() {
            isMozilla || isWebkit || (bFullscreen && _jArea.height("100%").css("height", _jArea.outerHeight() - _jTools.outerHeight()),
            isIE && _jTools.hide().show())
        }
        function fixAppleSel(a) {
            if (a = a.target,
            a.tagName.match(/(img|embed)/i)) {
                var b = _this.getSel()
                  , c = _this.getRng(!0);
                c.selectNode(a),
                b.removeAllRanges(),
        ...
        function xheAttr(a, b, c) {
            if (!b)
                return !1;
            var d = "_xhe_" + b;
            return c && (urlType && (c = getLocalUrl(c, urlType, urlBase)),
            a.attr(b, urlBase ? getLocalUrl(c, "abs", urlBase) : c).removeAttr(d).attr(d, c)),
            a.attr(d) || a.attr(b)
        }
        ...
        function getLocalUrl(a, b, c) {
            ...
            "" === i ? i = "/" : "/" !== i.charAt(0) && (i = "/" + i),
            a = $.trim(a),
            "abs" !== b && (a = a.replace(new RegExp(e + "\\/\\/" + g.replace(/\./g, "\\.") + "(?::" + h + ")" + ("80" === h ? "?" : "") + "(/|$)","i"), "/")),
            "rel" === b && (a = a.replace(new RegExp("^" + i.replace(/([\/\.\+\[\]\(\)])/g, "\\$1"),"i"), "")),
            "rel" !== b && (a.match(/^(https?:\/\/|\/)/i) || (a = i + a),
            "/" === a.charAt(0))) {
                var j, k, l = [], m = a.split("/"), n = m.length;
                for (k = 0; n > k; k++)
                    j = m[k],
        ...
        function checkFileExt(a, b) {
            return "*" === b || a.match(new RegExp(".(" + b.replace(/,/g, "|") + ")$","i")) ? !0 : (alert(getLang("upload.extLimit", b)),
            !1)
        }
        ...
        if (plugins && (arrTools = $.extend({}, arrTools, plugins),
        $.each(plugins, function(a) {
            strPlugins.push(a)
        }
        ),
        strPlugins = strPlugins.join(",")),
        settings.tools.match(/^\s*(m?full|simple|mini)\s*$/i)) {
        ...
        this.init = function() {
            function a(a) {
                var b, c = $(a.target);
                (b = c.css("width")) && c.css("width", "").attr("width", b.replace(/[^0-9%]+/g, "")),
                (b = c.css("height")) && c.css("height", "").attr("height", b.replace(/[^0-9%]+/g, ""))
            }
            ;var ucss = '/assets/widget.modules.path/zc63cdd34/plugins/editor/xheditor/xheditor_skin/default/';
            0 === $("#" + idCSS).length && $("head");
            ...
            var e, f, g = settings.background || _text.style.background, h = ['<span class="xheGStart"/>'], i = /\||\//i;
            $.each(settings.tools, function(a, b) {
                if (b.match(i) && h.push('<span class="xheGEnd"/>'),
                "|" === b)
                    h.push('<span class="xheSeparator"/>');
                else if ("/" === b)
                    h.push("<br />");
                else {
                    if (e = arrTools[b],
            ...
            if (j)
                if (is(j, "array"))
                    for (var k in j)
                        headHTML += '<link rel="stylesheet" href="' + j[k] + '"/>';
                else
                    headHTML += j.match(/\s*<style(\s+[^>]*?)?>[\s\S]+?<\/style>\s*/i) ? j : '<link rel="stylesheet" href="' + j + '"/>';
            var l = '<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" style="height:100%;margin:0"><head>' + headHTML + "<title>{#defaultReadTip} " + (settings.readTip ? settings.readTip : "") + "</title>";
            g && (l += "<style>html{background:" + g + ";}</style>"),
            l += '</head><body spellcheck="0" class="editMode' + bodyClass + '" style="height:100%;margin:0"></body></html>',
            ...
            _jTools.append(getLang(h.join(""))).bind("mousedown contextmenu", returnFalse).click(function(a) {
                ...
                return b.is(".xheEnabled") && (clearTimeout(timer),
                _jTools.find("a").attr("tabindex", "-1"),
                ev = a,
                _this.exec(b.attr("cmd"))),
                !1
            }
            ),
            _jTools.find(".xheButton").hover(function(a) {
                var b = $(this)
                  ...
                  , d = lastAngle;
                if (lastAngle = null ,
                -1 === c || bDisableHoverExec || !b.is(".xheEnabled"))
                    return !1;
                if (d && d > 10)
                    return bDisableHoverExec = !0,
                    setTimeout(function() {
                        bDisableHoverExec = !1
                    }
                    , 100),
                ...
                var e = b.attr("cmd")
                  , f = 1 === arrTools[e].h;
                return f ? (bQuickHoverExec && (c = 0),
                void (c >= 0 && (timer = setTimeout(function() {
                    ev = a,
                    lastPoint = {
                        x: ev.clientX,
                        y: ev.clientY
            ...
            bCheckEscInit || ($(document).keydown(checkEsc),
            bCheckEscInit = !0),
            ...
            _jDoc.mousedown(clickCancelPanel).keydown(checkShortcuts).keypress(forcePtag).dblclick(checkDblClick).bind("mousedown click", function(a) {
                _jText.trigger(a.type)
            }
            ),
            isIE && (_jDoc.keydown(function(a) {
                var b = _this.getRng();
                return 8 === a.which && b.item ? ($(b.item(0)).remove(),
                !1) : void 0
            }
            ),
            ...
            _jDoc.keydown(function(a) {
                var b = a.which;
                return a.altKey && b >= 49 && 57 >= b ? (_jTools.find("a").attr("tabindex", "0"),
                _jTools.find(".xheGStart").eq(b - 49).next().find("a").focus(),
                _doc.title = "\ufeff\ufeff",
                !1) : void 0
            }
            ).click(function() {
            ...
            _jTools.keydown(function(a) {
                ...
                if (27 == b)
                    _jTools.find("a").attr("tabindex", "-1"),
                    _this.focus();
                else if (a.altKey && b >= 49 && 57 >= b)
                    return _jTools.find(".xheGStart").eq(b - 49).next().find("a").focus(),
                    !1
            }
            );
            ...
            settings.html5Upload && n.bind("dragenter dragover", function(a) {
                var b;
                ...
                function b(a) {
                    ...
                    for (e = 0; e < a.length; e++) {
                        if (c = a[e].name.replace(/.+\./, ""),
                        !(b = g.match(new RegExp("(\\w+):[^:]*," + c + "(?:,|$)","i"))))
                            return 1;
                        if (d) {
                            if (d !== b[1])
                                return 2
                ...
                if (d && (c = d.files) && c.length > 0) {
                    var e, f, g, h = ["Link", "Img", "Flash", "Media"], i = [];
                    for (e in h)
                        f = h[e],
                        settings["up" + f + "Url"] && settings["up" + f + "Url"].match(/^[^!].*/i) && i.push(f + ":," + settings["up" + f + "Ext"]);
                    return 0 === i.length ? !1 : (g = i.join(","),
                    f = b(c),
                    1 === f ? alert(getLang("upload.extLimit", g.replace(/\w+:,/g, ""))) : 2 === f ? alert(getLang("upload.typeLimit")) : f && _this.startUpload(c, settings["up" + f + "Url"], "*", function(a) {
                        var b, c = [], d = settings.onUpload;
                        d && d(a);
        ...
        ,
        this.focus = function() {
            if (bSource ? $("#sourceCode", _doc).focus() : _win.focus(),
            isIE) {
                var a = _this.getRng();
        ...
        this.setTextCursor = function(a) {
            ...
            if (isIE || isIE11)
                ...
                for (var d = a ? "lastChild" : "firstChild"; 3 != c.nodeType && c[d]; )
                    c = c[d];
                b.selectNode(c)
            }
            if (b.collapse(a ? !1 : !0),
        ...
        this.getRng = function(a) {
            ...
            try {
                a || (b = _this.getSel(),
                c = b.createRange ? b.createRange() : b.rangeCount > 0 ? b.getRangeAt(0) : null ),
        ...
        this.getParent = function(a) {
            ...
            return isIE ? b = c.item ? c.item(0) : c.parentElement() : (b = c.commonAncestorContainer,
            c.collapsed || c.startContainer === c.endContainer && c.startOffset - c.endOffset < 2 && c.startContainer.hasChildNodes() && (b = c.startContainer.childNodes[c.startOffset])),
            a = a ? a : "*",
            b = $(b),
        ...
        this.getSelect = function(a) {
            var b = _this.getSel()
              , c = _this.getRng()
              , d = !0;
            if (d = !c || c.item ? !1 : !b || 0 === c.boundingWidth || c.collapsed,
            "text" === a)
                return d ? "" : c.text || (b.toString ? b.toString() : "");
            var e;
            if (c.cloneContents) {
                var f, g = $("<div></div>");
                f = c.cloneContents(),
                ...
                e = is(c.item) ? c.item(0).outerHTML : is(c.htmlText) ? c.htmlText : c.toString();
            return d && (e = ""),
        ...
        this.pasteHTML = function(a, b) {
            ...
            if (a += "<" + (isIE ? "img" : "span") + ' id="_xhe_temp" width="0" height="0" />',
            d.insertNode) {
                if ($(d.startContainer).closest("style,script").length > 0)
                    return !1;
                d.deleteContents(),
                d.insertNode(d.createContextualFragment(a))
            } else
                "control" === c.type.toLowerCase() && (c.clear(),
                d = _this.getRng()),
                d.pasteHTML(a);
            var f = $("#_xhe_temp", _doc)
              , g = f[0];
            isIE ? (d.moveToElementText(g),
            d.select()) : (d.selectNode(g),
            c.removeAllRanges(),
            c.addRange(d)),
            f.remove()
        }
        ...
        this.appendHTML = function(a) {
            return bSource ? !1 : (_this.focus(),
            a = _this.processHTML(a, "write"),
            $(_doc.body).append(a),
            void _this.setTextCursor(!0))
        }
        ,
        ...
        this.setSource = function(a) {
            ...
            a = _this.formatXHTML(a),
            a = _this.processHTML(a, "write"),
            isIE ? (_doc.body.innerHTML = '<img id="_xhe_temp" width="0" height="0" />' + a,
            $("#_xhe_temp", _doc).remove()) : _doc.body.innerHTML = a)
        }
        ,
        this.processHTML = function(a, b) {
            function c(a, b, c, d, e, g) {
                var h, i, j, k, l = "";
                if (h = d.match(/font-family\s*:\s*([^;"]+)/i),
                h && (l += ' face="' + h[1] + '"'),
                i = d.match(/font-size\s*:\s*([^;"]+)/i)) {
                    i = i[1].toLowerCase();
                    ...
                    j && (l += ' size="' + j + '"',
                    d = d.replace(/(^|;)(\s*font-size\s*:\s*[^;"]+;?)+/gi, "$1"))
                }
                if (k = d.match(/(?:^|[\s;])color\s*:\s*([^;"]+)/i)) {
                    ...
                    if (n = k[1].match(/\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i)) {
                        k[1] = "#";
                        for (var o = 1; 3 >= o; o++)
                            k[1] += ("0" + (n[o] - 0).toString(16)).slice(-2)
                    }
                ...
                "" !== l ? (d && (l += ' style="' + d + '"'),
                "<font" + (c ? c : "") + l + (e ? e : "") + ">" + g + "</font>") : a
            }
            function d(a, b, c, d, e) {
                for (var f, h, i = (c ? c : "") + (d ? d : ""), j = [], k = [], l = 0; l < g.length; l++)
                    f = g[l].r,
                    h = g[l].t,
                    i = i.replace(f, function() {
                        return j.push("<" + h + ">"),
                        k.push("</" + h + ">"),
                        ""
                    }
            ...
            if ("write" === b)
                a = a.replace(/(<(\/?)(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*((\/?)>)/g, function(a, b, c, d, f, g, h) {
                    d = d.toLowerCase(),
                    isMozilla ? "strong" === d ? d = "b" : "em" === d && (d = "i") : isWebkit && ("strong" === d ? (d = "span",
                    c || (f += e + ' style="font-weight: bold;"')) : "em" === d ? (d = "span",
                    c || (f += e + ' style="font-style: italic;"')) : "u" === d ? (d = "span",
                    c || (f += e + ' style="text-decoration: underline;"')) : "strike" === d && (d = "span",
                    c || (f += e + ' style="text-decoration: line-through;"')));
                    var i, j = "";
                    if ("del" === d)
                        d = "strike";
                    else if ("img" === d)
                        f = f.replace(/\s+emot\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function(a, b) {
                        ...
                        !f.match(/ href=[^ ]/i) && f.match(/ name=[^ ]/i) && (j += " xhe-anchor"),
                        h && (g = "></a>");
                    else if ("table" === d && !c) {
                    ...
                    if (f = f.replace(/\s+([\w\-:]+)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/g, function(a, b, c) {
                        ...
                        c = c.match(/^(["']?)(.*)\1/)[2],
                        aft = "",
                        isIE && b.match(/^(disabled|checked|readonly|selected)$/) && c.match(/^(false|0)$/i) ? "" : "img" === d && i && "src" === b ? "" : (b.match(/^(src|href)$/) && (aft = " _xhe_" + b + '="' + c + '"',
                        urlBase && (c = getLocalUrl(c, "abs", urlBase))),
                        j && "class" === b && (c += " " + j,
                        j = ""),
                        isWebkit && "style" === b && "span" === d && c.match(/(^|;)\s*(font-family|font-size|color|background-color)\s*:\s*[^;]+\s*(;|$)/i) && (l = !0),
                        " " + b + '="' + c + '"' + aft)
                    }
                    ),
                    i) {
                ...
                isIE && (a = a.replace(/&apos;/gi, "&#39;")),
                isWebkit || (a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/gi, c),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/gi, c),
                a = a.replace(/<(span)(\s+[^>]*?)?\s+style\s*=\s*"((?:[^"]*?;)?\s*(?:font-family|font-size|color)\s*:[^"]*)"( [^>]*)?>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/gi, c)),
                ...
                if (isWebkit)
                    for (var g = [{
                        ...
                        a = a.replace(/<(span)(\s+[^>]*?)?\s+class\s*=\s*"Apple-style-span"(\s+[^>]*?)?>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/gi, d),
        ...
        this.getSource = function(a) {
            ...
            return bSource ? (b = $("#sourceCode", _doc).val(),
            c || (b = _this.formatXHTML(b, !1))) : (b = _this.processHTML(_doc.body.innerHTML, "read"),
            b = _this.cleanHTML(b),
        ...
        this.cleanWord = function(a) {
            ...
            if (c > 0 && 3 > c && /mso(-|normal)|WordDocument|<table\s+[^>]*?x:str|\s+class\s*=\s*"?xl[67]\d"/i.test(a)) {
                ...
                a = a.replace(/\r?\n/gi, ""),
                isIE ? (a = a.replace(/<v:shapetype(\s+[^>]*)?>[\s\S]*<\/v:shapetype>/gi, ""),
                a = a.replace(/<v:shape(\s+[^>]+)?>[\s\S]*?<v:imagedata(\s+[^>]+)?>\s*<\/v:imagedata>[\s\S]*?<\/v:shape>/gi, function(a, b, c) {
                    var d;
                ...
                a = a.replace(/(<(\/?)([\w\-:]+))((?:\s+[\w\-:]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))?)*)\s*(\/?>)/g, function(a, b, d, e, f, g) {
                    ...
                    e.match(/^(link)$/) && f.match(/file:\/\//i) || e.match(/:/) || "span" === e && 2 === c ? "" : (d || (f = f.replace(/\s([\w\-:]+)(?:\s*=\s*("[^"]*"|'[^']*'|[^>\s]+))?/gi, function(a, b, d) {
                        if (b = b.toLowerCase(),
                        /:/.test(b))
                            return "";
                        if (d = d.match(/^(["']?)(.*)\1/)[2],
                        1 === c)
                            ...
                            case "p":
                                if ("style" === b)
                                    return d = d.replace(/"|&quot;/gi, "'").replace(/\s*([^:]+)\s*:\s*(.*?)(;|$)/gi, function(a, b, c) {
                            ...
                            case "span":
                                ...
                                break;
                            case "table":
                                if (b.match(/^(cellspacing|cellpadding|border|width)$/i))
                                    return a;
                                break;
                            case "td":
                                if (b.match(/^(rowspan|colspan)$/i))
                                    return a;
                                if ("style" === b)
                                    return d = d.replace(/"|&quot;/gi, "'").replace(/\s*([^:]+)\s*:\s*(.*?)(;|$)/gi, function(a, b, c) {
                ...
                for (var d = 0; 3 > d; d++)
                    a = a.replace(/<(span|a)>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?<\/\1>)*?)<\/\1>/gi, b);
                for (var d = 0; 3 > d; d++)
                    a = a.replace(/<(span|a)>(((?!<\1(\s+[^>]*?)?>)[\s\S]|<\1(\s+[^>]*?)?>((?!<\1(\s+[^>]*?)?>)[\s\S])*?<\/\1>)*?)<\/\1>/gi, b);
                for (var d = 0; 3 > d; d++)
                    a = a.replace(/<(span|a)>(((?!<\1(\s+[^>]*?)?>)[\s\S])*?)<\/\1>/gi, b);
                for (var d = 0; 3 > d; d++)
                    a = a.replace(/<font(\s+[^>]+)><font(\s+[^>]+)>/gi, function(a, b, c) {
                        return "<font" + b + c + ">"
                    }
                    );
        ...
        this.cleanHTML = function(a) {
            ...
            settings.linkTag && settings.inlineScript && settings.inlineStyle || (a = a.replace(/(<(\w+))((?:\s+[\w-]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/gi, function(a, b, c, d, e) {
                return settings.linkTag || "link" !== c.toLowerCase() ? (settings.inlineScript || (d = d.replace(/\s+on(?:click|dblclick|mouse(down|up|move|over|out|enter|leave|wheel)|key(down|press|up)|change|select|submit|reset|blur|focus|load|unload)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/gi, "")),
                settings.inlineStyle || (d = d.replace(/\s+(style|class)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/gi, "")),
                b + d + e) : ""
            }
            )),
        ...
        this.formatXHTML = function(a, b) {
            ...
            function f(a) {
                if (a)
                    for (var b = w.length - 1; b >= 0 && w[b] !== a; b--)
                        ;
                else
                    var b = 0;
                if (b >= 0) {
                    for (var c = w.length - 1; c >= b; c--)
                        j("</" + w[c] + ">", w[c]);
                    w.length = b
                }
                "pre" === a && (H = !1,
            ...
            ;
            for (var x, y, z, A, B, C, D, E = 0, F = -1, G = "body", H = !1; x = t.exec(a); )
                y = x.index,
                y > E && (C = a.substring(E, y),
                A ? B.push(C) : g(C)),
                E = t.lastIndex,
                !(z = x[1]) || (z = d(z),
                A && z === A && (h(B.join("")),
        ...
        this.toggleShowBlocktag = function(a) {
            if (bShowBlocktag !== a) {
                ...
                var b = $(_doc.body);
                bShowBlocktag ? (bodyClass += " showBlocktag",
                b.addClass("showBlocktag")) : (bodyClass = bodyClass.replace(" showBlocktag", ""),
                b.removeClass("showBlocktag"))
            }
        }
        ,
        this.toggleSource = function(a) {
            if (bSource !== a) {
                ...
                var b, c, d = _doc.body, e = $(d), f = '<span id="_xhe_cursor"></span>', g = 0, h = "";
                if (bSource ? (b = _this.getSource(),
                e.html("").removeAttr("scroll").attr("class", "editMode" + bodyClass),
                isIE ? d.contentEditable = "true" : _doc.designMode = "On",
                isMozilla && (_this._exec("inserthtml", "-"),
                $("#" + idFixFFCursor).show().focus().hide()),
                h = "Source") : (_this.pasteHTML(f, !0),
                b = _this.getSource(!0),
                g = b.indexOf(f),
                isOpera || (g = b.substring(0, g).replace(/\r/g, "").length),
                b = b.replace(/(\r?\n\s*|)<span id="_xhe_cursor"><\/span>(\s*\r?\n|)/, function(a, b, c) {
                    return b && c ? "\r\n" : b + c
                }
                ),
                isIE ? d.contentEditable = "false" : _doc.designMode = "Off",
                e.attr("scroll", "no").attr("class", "sourceMode").html('<textarea id="sourceCode" wrap="soft" spellcheck="false" style="width:100%;height:100%" />'),
                c = $("#sourceCode", e).blur(_this.getSource)[0],
                h = "WYSIWYG"),
                bSource = !bSource,
                _this.setSource(b),
                _this.focus(),
        ...
        this.toggleFullscreen = function(a) {
            if (bFullscreen !== a) {
                var b = $("#" + idContainer).find(".xheLayout")
                  ...
                  , e = isIE && (6 == d || 7 == d);
                bFullscreen ? (e && _jText.after(c),
                b.attr("style", sLayoutStyle),
                ...
                sLayoutStyle = b.attr("style"),
                b.removeAttr("style"),
                _jArea.height("100%"),
                setTimeout(fixFullHeight, 100)),
                isMozilla ? ($("#" + idFixFFCursor).show().focus().hide(),
                setTimeout(_this.focus, 1)) : e && _this.setTextCursor(),
        ...
        this.showMenu = function(a, b) {
            ...
            c.click(function(a) {
                return a = a.target,
                $.nodeName(a, "DIV") ? void 0 : (_this.loadBookmark(),
                b($(a).closest("a").attr("v")),
                _this.hidePanel(),
                !1)
            }
        ...
        this.showColor = function(a) {
            ...
            c.click(function(b) {
                return b = b.target,
                $.nodeName(b, "A") ? (_this.loadBookmark(),
                a($(b).attr("xhev")),
                _this.hidePanel(),
                !1) : void 0
            }
        ...
        this.showLink = function() {
            ...
            1 === f.length) {
                ...
                "" === k && g.val(getLang(settings.defLinkText)).closest("div").show();
            settings.upLinkUrl && _this.uploadInit(h, settings.upLinkUrl, settings.upLinkExt),
            j.click(function() {
                _this.loadBookmark();
                var a = h.val();
                if (("" === a || 0 === f.length) && _this._exec("unlink"),
                "" !== a && "http://" !== a) {
                    var b = a.split(" ")
                      , c = i.val()
                      , d = g.val();
                    if (b.length > 1) {
                        ...
                        for (var m = 0, n = b.length; n > m; m++)
                            ...
                            "" !== a && (a = a.split("||"),
                            e = j,
                            e = e.replace("xhe_tmpurl", a[0]),
                            e = e.replace("xhe_tmptext", a[1] ? a[1] : d),
                            l.push(e));
                        ...
                        d || (d = a[0]),
                        d = a[1] ? a[1] : "" !== k ? "" : d ? d : a[0],
                        0 === f.length ? (d ? _this.pasteHTML('<a href="#xhe_tmpurl">' + d + "</a>") : _this._exec("createlink", "#xhe_tmpurl"),
                        f = $('a[href$="#xhe_tmpurl"]', _doc)) : d && !isWebkit && f.text(d),
                        xheAttr(f, "href", a[0]),
                ...
                if ("" !== a && "http://" !== a) {
                    ...
                    if (k.length > 1) {
                        ...
                        for (var v in k)
                            ...
                            "" !== a && (a = a.split("||"),
                            s = t,
                            s = s.replace("xhe_tmpurl", a[0]),
                            a[1] && (s = '<a href="' + a[1] + '" target="_blank">' + s + "</a>"),
                            u.push(s));
                        _this.pasteHTML(u.join("&nbsp;"))
                    } else if (1 === k.length && (a = k[0],
                    "" !== a && (a = a.split("||"),
                    0 === b.length && (_this.pasteHTML('<img src="' + a[0] + '#xhe_tmpurl" />'),
                    b = $('img[src$="#xhe_tmpurl"]', _doc)),
                    xheAttr(b, "src", a[0]),
                    "" !== l && b.attr("alt", l),
                    "" !== m ? b.attr("align", m) : b.removeAttr("align"),
                    "" !== n ? b.attr("width", n) : b.removeAttr("width"),
                    "" !== o ? b.attr("height", o) : b.removeAttr("height"),
                    "" !== p ? b.attr("border", p) : b.removeAttr("border"),
                    "" !== q ? b.attr("vspace", q) : b.removeAttr("vspace"),
                    "" !== r ? b.attr("hspace", r) : b.removeAttr("hspace"),
                    a[1]))) {
                        var w = b.parent("a");
                        0 === w.length && (b.wrap("<a></a>"),
                        w = b.parent("a")),
                        xheAttr(w, "href", a[1]),
        ...
        this.showEmbed = function(a, b, c, d, e, f, g) {
            ...
            1 === i.length && (j.val(xheAttr(i, "src")),
            k.val(i.attr("width")),
            l.val(i.attr("height"))),
            m.click(function() {
                _this.loadBookmark();
                ...
                if ("" !== a && "http://" !== a) {
                    ...
                    if (m.length > 1) {
                        ...
                        1 === m.length && (a = m[0].split("||"),
                        0 === i.length && (_this.pasteHTML(h.replace("xhe_tmpurl", a[0] + "#xhe_tmpurl") + " />"),
                        i = $('embed[src$="#xhe_tmpurl"]', _doc)),
                        xheAttr(i, "src", a[0]),
                        i.attr("width", a[1] ? a[1] : b),
                        i.attr("height", a[2] ? a[2] : f))
                } else
                    1 === i.length && i.remove();
                return _this.hidePanel(),
                !1
        ...
        this.showEmot = function(a) {
            ...
            s > 1 && (t.push('</ul><br style="clear:both;" />'),
            r = $(getLang(t.join(""))).click(function(a) {
        ...
        this.showTable = function() {
            ...
            l.click(function() {
                _this.loadBookmark();
                var a, l, m = k.val(), n = g.val(), o = b.val(), p = c.val(), q = d.val(), r = e.val(), s = f.val(), t = h.val(), u = i.val(), v = j.val(), w = "<table" + ("" !== n ? ' border="' + n + '"' : "") + ("" !== r ? ' width="' + r + '"' : "") + ("" !== s ? ' height="' + s + '"' : "") + ("" !== t ? ' cellspacing="' + t + '"' : "") + ("" !== u ? ' cellpadding="' + u + '"' : "") + ("" !== v ? ' align="' + v + '"' : "") + ">";
                if ("" !== m && (w += "<caption>" + m + "</caption>"),
                "row" === q || "both" === q) {
                    for (w += "<tr>",
                    a = 0; p > a; a++)
                        w += '<th scope="col"></th>';
                ...
                a = 0; o > a; a++) {
                    for (w += "<tr>",
                    l = 0; p > l; l++)
                        w += 0 !== l || "col" !== q && "both" !== q ? "<td></td>" : '<th scope="row"></th>';
                    w += "</tr>"
                }
        ...
        this.uploadInit = function(a, b, c) {
            function d(b) {
                is(b, "string") && (b = [b]);
                var c, d, e, f = !1, g = b.length, h = [], i = settings.onUpload;
                for (i && i(b),
                c = 0; g > c; c++)
                    d = b[c],
            ...
            if (a.after(e),
            f.before(a),
            b = b.replace(/{editorRoot}/gi, editorRoot),
            "!" === b.substr(0, 1))
                f.click(function() {
        ...
        this.startUpload = function(fromFiles, toUrl, limitExt, onUploadComplete) {
            function onUploadCallback(sText, bFinish) {
                ...
                return data.err === undefined || data.msg === undefined ? alert(getLang("upload.apiError", toUrl, sText)) : data.err ? alert(data.err) : (arrMsg.push(data.msg),
                bOK = !0),
            ...
            if (!isOpera && bHtml5Upload && (!fromFiles.nodeType || (fileList = fromFiles.files) && fileList[0].name)) {
                ...
                if (len > upMultiple)
                    return void alert(getLang("upload.countLimit", upMultiple));
                for (i = 0; len > i; i++)
                ...
                upload = new _this.html5Upload(uploadInputname,fileList,toUrl,onUploadCallback,function(a) {
                    if (a.loaded >= 0) {
        ...
        this.html5Upload = function(a, b, c, d, e) {
            function f(b, c, d, e) {
                ...
                h.setRequestHeader("X-File-Name", encodeURIComponent(b.name)),
            ...
            for (var h, i = 0, j = b.length, k = 0, l = 0, m = this, n = 0; j > n; n++)
                l += b[n].size;
            this.remove = function() {
                h && (h.abort(),
                h = null )
            ...
            this.uploadNext = function(a) {
                a && (k += b[i - 1].size,
                g(0)),
                (!a || a && d(a, i === j) === !0) && j > i && f(b[i++], c, m.uploadNext, function(a) {
                    g(a)
                }
                )
            }
        ...
        this.showIframeModal = function(title, url, callback, w, h, onRemove) {
            ...
            jIframe.load(function() {
                ...
                jWait.is(":visible") && (jIframe.show().focus(),
                jWait.remove())
            }
            )
        }
        ...
        this.showModal = function(a, b, c, d, e) {
            return bShowModal ? !1 : (_this.panelState = bShowPanel,
            bShowPanel = !1,
            layerShadow = settings.layerShadow,
            c = c ? c : settings.modalWidth,
            d = d ? d : settings.modalHeight,
            jModal = $(getLang('<div class="xheModal" style="width:' + (c - 1) + "px;height:" + d + "px;margin-left:-" + Math.ceil(c / 2) + "px;" + (isIE && 7 > browerVer ? "" : "margin-top:-" + Math.ceil(d / 2) + "px") + '">' + (settings.modalTitle ? '<div class="xheModalTitle"><span class="xheModalClose" title="{#close} (Esc)" tabindex="0" role="button"></span>' + a + "</div>" : "") + '<div class="xheModalContent"></div></div>')).appendTo("body"),
            jOverlay = $('<div class="xheModalOverlay"></div>').appendTo("body"),
            layerShadow > 0 && (jModalShadow = $('<div class="xheModalShadow" style="width:' + jModal.outerWidth() + "px;height:" + jModal.outerHeight() + "px;margin-left:-" + (Math.ceil(c / 2) - layerShadow - 2) + "px;" + (isIE && 7 > browerVer ? "" : "margin-top:-" + (Math.ceil(d / 2) - layerShadow - 2) + "px") + '"></div>').appendTo("body")),
            $(".xheModalContent", jModal).css("height", d - (settings.modalTitle ? $(".xheModalTitle").outerHeight() : 0)).html(b),
            isIE && 6 === browerVer && (jHideSelect = $("select:visible").css("visibility", "hidden")),
            $(".xheModalClose", jModal).click(_this.removeModal),
            jOverlay.show(),
            layerShadow > 0 && jModalShadow.show(),
            jModal.show(),
            setTimeout(function() {
        ...
        this.showDialog = function(a, b) {
            ...
            if (1 === e.length) {
                if (d.find("input[type=text],select").keypress(function(a) {
                    return 13 === a.which ? (e.click(),
                    !1) : void 0
                }
                ),
                d.find("textarea").keydown(function(a) {
                    return a.ctrlKey && 13 === a.which ? (e.click(),
                    !1) : void 0
                }
                ),
                e.after(getLang(' <input type="button" id="xheCancel" value="{#dialogCancel}" />')),
                $("#xheCancel", d).click(_this.hidePanel),
                !settings.clickCancelDialog) {
                    bClickCancel = !1;
        ...
        this.showPanel = function(a, b) {
            ...
            i && !isNaN(i) && (_jShadow.css("zIndex", parseInt(i, 10) + 1),
            _jPanel.css("zIndex", parseInt(i, 10) + 2),
            _jCntLine.css("zIndex", parseInt(i, 10) + 3)),
            _jPanel.css({
                left: d,
                top: e
            }).show(),
        ...
        this.hidePanel = function() {
            bShowPanel && (_jPanelButton.removeClass("xheActive"),
            _jShadow.hide(),
            _jCntLine.hide(),
            _jPanel.hide(),
            bShowPanel = !1,
            bClickCancel || ($(".xheFixCancel").remove(),
            bClickCancel = !0),
            bQuickHoverExec = bDisableHoverExec = !1,
            lastAngle = null ,
            _this.focus(),
            _this.loadBookmark())
        }
        ...
        this.exec = function(a) {
            ...
            if (b.e)
                ...
                case "cut":
                    try {
                        if (_doc.execCommand(a),
                        !_doc.queryCommandSupported(a))
                            throw "Error"
                    } catch (d) {
                ...
                case "backcolor":
                    _this.showColor(function(a) {
                        isIE ? _this._exec("backcolor", a) : (setCSS(!0),
    ...
    $.fn.xheditor = function(options) {
        ...
        return this.each(function() {
            if ($.nodeName(this, "TEXTAREA"))
                if (options === !1)
                    this.xheditor && (this.xheditor.remove(),
                    this.xheditor = null );
                    ...
                    editor.init() ? (this.xheditor = editor,
                    arrSuccess.push(editor)) : editor = null 
                }
        }
        ),
